...
def main():
    # Define the file paths and keyword file
    text_files = ["ebm-en.txt", "ebm-de.txt", "bwl-en.txt", "bwl-de.txt"]
    ...
    # Collect unique words with at least one match in each text file and save to file
